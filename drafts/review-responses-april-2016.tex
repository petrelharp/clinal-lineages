...
\reply
\yb{We agree that a long set of theoretical results can be tedious. We have therefore reshaped the introduction to highlight our major question ``How does selection against incompatibilities in a hybrid zone influence the length distribution of ancestry tracts?'' }
