...
\begin{figure}
    ...
    \caption{
        \textbf{Mean haplotype lengths of $A$ haplotypes} \alisa{Should this be $B$ haplotypes? That is what the figure title seems to indicate}, $l(x,m)$ \alisa{this would need to be changed to either $l_A$ or $l_B$},
...
\begin{figure}
    \includegraphics[height=0.8\textheight]{figs/cond_freqs_comparison_tau_80}
    \caption{
...
\begin{figure}
    \includegraphics{figs/cond_freqs_comparison_tau_1280}
    \caption{
