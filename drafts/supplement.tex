...
\begin{figure}
    ...
    \includegraphics{figs/s001_adjacentBlocksAlongChromNoConditioningHighRes}
        \caption{
     Block lengths along chromosome under $s=0.001$ and other parameters as for Fig.~\ref{Fig:blockLengths}, conditioning on ancestry B (top) and without conditioning (bottom) } \label{sfig:blockLengthPlot_t1000_s0.001}
\end{figure}
