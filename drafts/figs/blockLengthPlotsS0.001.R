...
####s=0.001:
load("simulation_SIGMA1_Ninds25000_ndemes50_s0.001_tau1000_chr1_start0.49_stop0.51_by0.0001_flanking.blocks.by.ind.Robj")
load("simulation_SIGMA1_Ninds25000_ndemes50_s0.001_tau1000_chr1_start0.49_stop0.51_by0.0001_flanking.blocks.by.ind.AncB.Robj")

load("simulation_SIGMA1_Ninds25000_ndemes50_s0.001_tau1000_chr1_start0.49_stop0.51_by0.0001_intervalSizes_allAncs.Robj")
load('simulation_SIGMA1_Ninds25000_ndemes50_s0.001_tau1000_chr1_start0.49_stop0.51_by0.0001_intervalSizes.Robj')
...
#positions=seq(0.495,0.505,0.0001)
positions=seq(0.49,0.51,0.0001)
...
pdf(height=4, width=6.25,file="s0.001_adjacentBlocksAlongChromNoConditioningHighRes.pdf")
par(mar=c(3.5,3.5,0.5,0.5))
matplot(t(flanking.blocks.deme.matrix/apply(flanking.blocks.deme.matrix,1,mean))[,50:1],xaxt="n",yaxt="n",xlab="",ylab="",lty=1,col=rainbow(50),type="l",x=positions,ylim=c(0.5,1.75))
axis(1,at=seq(0.49,0.51,0.001),labels=seq(-0.01,0.01,0.001)*100,cex.axis=0.9)
...
plot(flanking.blocks.deme.matrix.AncB[1,]/mean(flanking.blocks.deme.matrix.AncB[1,],na.rm=T),x=positions,ylim=c(0.5,1.75),type="l",lty=1,col="white",main="",cex.main=0.8,xlab="",ylab="",yaxt="n",xaxt="n")
...
pdf(height=4, width=6.25,file="s0.001_ratioAdjacentBlocksAlongChromNoConditioningHighRes.pdf")
par(mar=c(3.5,3.5,0.5,0.5))
plot(ratio.blocks[,1]/mean(ratio.blocks[,1],na.rm=T),x=positions,ylim=c(0.5,1.75),type="l",lty=1,col="white",main="",cex.main=0.8,xlab="",ylab="",yaxt="n",xaxt="n")
...
pdf(height=4, width=6.25,file="s0.001_ratioAdjacentBlocksAlongChromHeatmapNoConditioningHighRes.pdf")
layout(c(1,2),heights=c(1,4))
par(mar=c(0.5,3.5,2,0.5))

	BREAKS = seq(1.5,3.75,0.25)
	...
	axis(1,at=seq(0.49,0.51,0.002),labels=seq(-1,1,0.2),cex.axis=0.9)
...
pdf(height=4, width=6.25,file="s0.001_ratioAdjacentBlocksAlongChromAncBConditioningHighRes.pdf")
...
plot(ratio.blocks.AncB[,1]/mean(ratio.blocks.AncB[,1],na.rm=T),x=positions,ylim=c(0.5,1.75),type="l",lty=1,col="white",main="",cex.main=0.8,xlab="",ylab="",yaxt="n",xaxt="n")
...
pdf(height=4, width=6.25,file="s0.001_ratioAdjacentBlocksAlongChromHeatmapAncBConditioningHighRes.pdf")

layout(c(1,2),heights=c(1,4))
par(mar=c(0.5,3.5,2,0.5))

	BREAKS = seq(0.25,5,0.25)
	COLORS = heat.colors(length(BREAKS)-1)
...
par(mar=c(3.5,3.5,0.5,0.5))
mean_per_deme = do.call(rbind, lapply(intervalSizes_allAncs,function(P){tapply(1:25000,deme_ID,function(Z){mean(P[Z,])})}))
plot(mean_per_deme[,1]/mean(mean_per_deme[,1],na.rm=T),x=positions,ylim=c(0.5,1.75),type="l",lty=1,col="white",main="",cex.main=0.8,xlab="",ylab="",yaxt="n",xaxt="n")
...
par(mar=c(3.5,3.5,0.5,0.5))
mean_per_deme_AncB = do.call(rbind, lapply(intervalSizes,function(P){tapply(1:25000,deme_ID,function(Z){all_sites = P[Z,]; mean(all_sites[which(all_sites>0)])})}))
plot(mean_per_deme_AncB[,1]/mean(mean_per_deme_AncB[,1],na.rm=T),x=positions,ylim=c(0.5,1.75),type="l",lty=1,col="white",main="",cex.main=0.8,xlab="",ylab="",yaxt="n",xaxt="n")
