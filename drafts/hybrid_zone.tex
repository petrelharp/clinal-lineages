...
The mixing of genomes across space, combined with selection, results in the formation of genetic clines. These patterns have been the traditional focus of both empirical and theoretical studies into hybrid zones. While here we focus on hybrid zones maintained by selection against hybrids -- \emph{tension zones} --
as in \citet{Bazykin1969}, reviewed in \citet{Barton1985}, clines may also be differential selection across environmental gradients \citep{Haldane1948,fisher1950frequencies}, generating \emph{ecotones}. Although these are, in principle different, theoretical analyses consistently show ecotones and tension zones have very similar properties \citep{Slatkin1973, barton1986barrier,Kruuk1999}, with the primary difference being that the center of a tension zone fluctuates over time \citep{Barton1979a} because stochastic changes in allele frequency can shit the cline center, while centers of ecotones do not change unless the environmental gradient changes. 

Our work here builds on the large body of theory describing tension zones. While much of the previous work describes equilibrium states of genetic clines, we focus on \emph{transient} patterns after the initial formation of a tension zone, in particular describing \emph{haplotype} patterns. Although the selected allele frequency cline establishes quickly, transient patterns can persist for quite some time, and  haplotypes can potentially carry substantial information about the formation of recent zones.
...
or the discrete analogues \citep{hanson1966effects}. There is substantial work on how clines are affected by genetic drift \citep{Slatkin1975,felsenstein1975genetic,barton2008effect,Polechova2011},
...
\yb{While we cannot analytically derive expectations for finite populations, our simulation results (below) suggest that genetic drift does not substantially influence our conclusions, perhaps because of the short time-scales that we examine.} \alisa{Our results present a possible approach for identifying genomic regions experiencing selection in hybrid zones.}
