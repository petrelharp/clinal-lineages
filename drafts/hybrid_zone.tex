...
although because of the well-known problems with spatial coalescence \citep{felsenstein1975pain,barton2002neutral},
...
% equilibrium states of clines at selected loci \citep{Nagylaki1975,barton1979dynamics,Barton1986,Slatkin1973,Slatkin1975,May1975,Haldane1948}.  
...
% In particular \citet{barton1979gene,Barton1986} have described patterns of clinal variation at loci linked to targets of selection.  
...
\caption{
    ...
    i.e., showing where (horizontal axis) and when (vertical axis) the ancestors, from whom the haplotype was inherited, lived.
...
%YB DID SUBSTANTIAL EDITING OF THIS PARAGRAPH
The behavior of a lineage at a linked locus is similar to a selected locus. 
However, there is one important difference -- in heterozygotes the lineage linked to the selected locus may move between backgrounds. 
...
We now find the probability of maintaining an \emph{entire} block of genome (haplotype) % thought `seeing' was too much about our inference rather than the the biological process
...
to have last had an ancestor on the $A$ side of the cline around $x/(\sigma\sqrt{s})$ generations ago 
...
But, if we assume they are \emph{independent}, 
...
we would expect to see, on average, $2q_A(x,T,r)/(1-q_A(x,T,r))$ \alisa{consecutive} blocks of ancestry $A$ about a given site unlinked \alisa{unlinked, or linked?} to the selected site.
