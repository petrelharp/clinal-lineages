...
As expected, we find that $F_B(m,X)$ is highest on the size of the hybrid zone where individuals of ancestry $B$ predominate. 
...
\subsection*{Other patterns of introgression}
