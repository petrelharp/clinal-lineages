...
\begin{figure}
    ...
    \caption{
        ...
        \textbf{(B)} a linked site at distance $r=0.1$, which continues to smooth out as $\sqrt{t}$.
        Other parameters.
       \plr{Do we want this figure? This one is just a placeholder; I'd put in two, that showed the formation and spread better.
      Maybe putting in simulation results would be better, with comparison to numerical solutions? But, this is easier to look at?}
