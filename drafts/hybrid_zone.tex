...
These patterns of correlated ancestry in admixed populations have been previously used to infer histories of hybridization and admixture \citep[e.g.][]{Gravel2012,Hellenthal2014,sedghifar2015spatial}.  
...
which may be identifiable as distinct haplotypes,
...
There is substantial work on how clines are affected by genetic drift \citep{Slatkin1975,felsenstein1975genetic,durrett2007width,barton2008effect,Polechova2011},
...
\plr{(nice wrap-up sentence shouldn't be at the end of paragraph on drift:)}
\alisa{Our results present a possible approach for identifying genomic regions experiencing selection in hybrid zones.}
...
\caption{
    ...
    The thick blue line represents the path of the selected locus. 
