...
a.  The haplotype of a $B$ allele at distance $x$ into the $A$ side should be of length about $\sigma/(sx)$, as long as this is less than $1/\tau$. (this is fairly restrictive)
