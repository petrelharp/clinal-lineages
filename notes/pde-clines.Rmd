...
is just the product of the kernel to itself;
on discretization this becomes a matrix power,
so the operator $u(a,b) \mapsto \int_a^b u(a,\theta)u(\theta,b) - u(a,b) d\theta$
```{r solve_branching}
