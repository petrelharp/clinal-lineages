...
and so
$$\begin{aligned}
p(x,\tau,r) =  p(x,\tau) q(x,A,\tau,r) + p(-x,\tau) (1-q(-x,A,\tau,r))A .
\end{aligned}$$
...
There are various haplotype-related statistics we could compute:

1.  Distance to closest recombination in a heterozygote
...
The first haplotype-related statistic
